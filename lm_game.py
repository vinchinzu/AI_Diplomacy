...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=int,
        default=3,  # Original default was 0, updated to common use
    ...
    parser.add_argument(
        "--max_years",
        type=int,
        default=None,  # Original was 1901, now optional
...
async def main():
    ...
    if args.fixed_models:
        ...
        args.fixed_models = [
            m.strip() for m in args.fixed_models.replace(" ", "").split(",")
        ]
    ...
    try:
        ...
        if (
            game and game_history and agent_manager
        ):  # Ensure game object and history exist
            logger.info(
...
if __name__ == "__main__":
    try:
        ...
        initial_logger = logging.getLogger(
            __name__
        )  # Use a basic logger if setup_logging failed
