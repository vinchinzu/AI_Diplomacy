...
from generic_llm_framework.core import GenericLLMAgentInterface # To ensure it implements
...
class TestGenericLLMAgent:
    ...
    def test_agent_initialization(self, agent, mock_llm_coordinator, mock_prompt_strategy, minimal_agent_config):
    ...
    @pytest.mark.asyncio
    async def test_generate_communication_llm_failure(self, agent, mock_llm_coordinator, mock_prompt_strategy):
    ...
    def test_update_internal_state(self, agent, caplog):
        ...
        with caplog.at_level(logging.INFO):
            asyncio.run(agent.update_internal_state(mock_env_state, mock_events)) # It's async
    ...
    @pytest.mark.asyncio
    async def test_decide_action_uses_default_constants(self, agent, mock_llm_coordinator, mock_prompt_strategy):
