    ...
    events_affecting_france = [
        {
            ...
            "attacker": "GERMANY",
            "target": "FRANCE",
            "details": "Munich attacks Burgundy",
        },
        {
            "type": "support",
            "supporter": "ITALY",
            "supported": "FRANCE",
            "details": "Rome supports Paris holds",
        },
        {
            "type": "attack",
            "attacker": "ENGLAND",
            "target": "FRANCE",
            "details": "London attacks Brest",
        },
        {
            "type": "attack",
            "attacker": "GERMANY",
            "target": "RUSSIA",
            "details": "Berlin attacks Warsaw",
        },  # Should not affect France's relationships
        {
            "type": "support",
            "supporter": "AUSTRIA",
            "supported": "ITALY",
            "details": "Vienna supports Rome",
        },  # Should not affect France's relationships
        {
            "type": "attack",
            "attacker": "TURKEY",
            "target": "FRANCE",
        },  # Test repeated attack
    ]
