...
class BuildPhaseStrategy:
    async def get_orders(
        ...
        # Identify powers that have builds/disbands
        ...
        for i, power_name in enumerate(powers_with_builds_or_disbands):
            # Skip if agent was not found and no task was created
