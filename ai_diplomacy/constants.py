...
ALLOWED_RELATIONSHIPS = ["Enemy", "Unfriendly", "Neutral", "Friendly", "Ally"] # Used by agent_state
...
DEFAULT_AGENT_MANAGER_FALLBACK_MODEL = "gemma3:4b" # Used in model_utils (moved from agent_manager)
...
PROMPT_TEMPLATE_FEW_SHOT = "few_shot_example.txt" # Used in prompt_constructor (though unused in logic)
PROMPT_TEMPLATE_ORDER_INSTRUCTIONS = "order_instructions.txt" # Used in prompt_constructor
...
PHASE_STRING_WINTER = "WINTER" # Used in orchestrators.phase_orchestrator (for max_years check)
...
# --- Context Provider Specific ---
CONTEXT_SECTION_HEADER_GAME_STATE = "=== GAME STATE ===" # Used in services.context_provider
CONTEXT_SECTION_HEADER_POSSIBLE_ORDERS = "=== YOUR POSSIBLE ORDERS ===" # Used in services.context_provider
CONTEXT_SECTION_HEADER_STRATEGIC_ANALYSIS = "=== STRATEGIC ANALYSIS ===" # Used in services.context_provider
CONTEXT_SECTION_HEADER_RECENT_MESSAGES = "=== RECENT MESSAGES ===" # Used in services.context_provider
MCP_TOOL_BOARD_STATE = "diplomacy.board_state" # Used in services.context_provider
MCP_TOOL_POSSIBLE_ORDERS = "diplomacy.possible_orders" # Used in services.context_provider
MCP_TOOL_RECENT_MESSAGES = "diplomacy.recent_messages" # Used in services.context_provider
...
LLM_CALL_ERROR_EMPTY_RESPONSE = "Empty or no response from LLM" # Used in services.llm_coordinator
...
DEFAULT_MODEL_PRICE_ESTIMATE_PAIR = (0.00015, 0.0006) # Fallback for services.usage_tracker
